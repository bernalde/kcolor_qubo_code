...
if __name__ == "__main__":
    ...
    annealing(instance=graph_type, TEST=TEST, prob=prob, K=K, overwrite_pickles=overwrite_pickles, draw_figures=draw_figures,
              annealing_time=annealing_time, chain_strengths=chain_strengths, penalties=penalties, samples=samples, sampler=sampler)
